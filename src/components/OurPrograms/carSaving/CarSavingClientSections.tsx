...
function CarSavingClientSections() {
  const { t, i18n } = useTranslation('carSaving');
          ...
          <div className="grid gap-5 md:grid-cols-3">
            <article className="rounded-[1.5rem] border border-[#c5962e]/20 bg-[#fffaf0] p-6">
              ...
              <h3 className="text-xl font-extrabold tracking-tight text-[#000000]">
                {t('clientSections.scope.marketplaceTitle')}
              </h3>
              <p className="mt-3 text-base leading-7 text-slate-600">
                {t('clientSections.scope.marketplaceText')}
              </p>
            </article>
            <article className="rounded-[1.5rem] border border-[#c5962e]/20 bg-[#fffaf0] p-6">
              <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-[#fff3d4] text-[#a97916]">
              ...
              <h3 className="text-xl font-extrabold tracking-tight text-[#000000]">
                {t('clientSections.scope.autoSavingTitle')}
              </h3>
              <p className="mt-3 text-base leading-7 text-slate-600">
                {t('clientSections.scope.autoSavingText')}
              </p>
            </article>
            <article className="rounded-[1.5rem] border border-[#c5962e]/30 bg-[#000000] p-6 text-white">
              <h3 className="text-xl font-extrabold tracking-tight">
                {t('clientSections.scope.carPlanTitle')}
              </h3>
              <p className="mt-3 text-base leading-7 text-slate-300">
                {t('clientSections.scope.carPlanText')}
              </p>
            </article>
          </div>
        </div>
...
export default CarSavingClientSections;
