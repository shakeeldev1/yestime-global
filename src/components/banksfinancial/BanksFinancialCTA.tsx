      ...
      <div className="mx-auto max-w-7xl overflow-hidden rounded-[30px] bg-[linear-gradient(90deg,#020b1b_0%,#000000_40%,#000000_100%)] p-7 sm:p-9 lg:p-12">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              to="/ContactUs"
              className="inline-flex items-center gap-2 rounded-xl bg-linear-to-r from-[#f5c54e] to-[#d99420] px-6 py-3 text-sm font-bold text-[#000000] shadow-[0_16px_32px_rgba(245,197,78,0.25)] transition-all duration-200 hover:-translate-y-0.5"
            >
              {t('cta.exploreButton')}
            ...
            <Link
              to="/contact-us"
              className="inline-flex text-white items-center gap-2 rounded-xl border border-[#f5c54e]/60 bg-[#000000]/50 px-6 py-3 text-sm font-bold text-white transition-all duration-200 hover:bg-white/10"
            >
