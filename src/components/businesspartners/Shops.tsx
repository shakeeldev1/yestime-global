          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-sm leading-relaxed text-[#55708F] sm:text-base">
                We engineer reliable, elite enterprise relationships built to withstand market evolution. Approved partners unlock priority access to high-tier commercial tools and sustained cross-collaboration opportunities.
              </p>
            </div>
