...
export const Showrooms: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-white py-16 sm:py-24">
      ...
      <div className="pointer-events-none absolute -left-24 -top-24 h-96 w-96 rounded-full bg-[#0B2341]/5 blur-[120px]" />
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid items-start gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="space-y-6">
            {/* Text Card */}
            <div className="relative overflow-hidden rounded-[2rem] border border-[#D9E3EF] bg-[#F8FAFC] p-8 shadow-xl shadow-[#0B2341]/5 sm:p-10">
              {/* Decorative Glows */}
              <div className="pointer-events-none absolute -right-20 -top-20 h-56 w-56 rounded-full bg-[#C6922B]/10 blur-3xl" />
              <div className="pointer-events-none absolute -bottom-20 -left-20 h-56 w-56 rounded-full bg-[#0B2341]/5 blur-3xl" />
            ...
            {/* ================= IMAGE CARD ================= */}
            <div className="group relative overflow-hidden rounded-[2rem] border border-[#D9E3EF] bg-white p-2 shadow-xl shadow-[#0B2341]/5 transition-all duration-500 hover:border-[#C6922B]/50 hover:shadow-2xl hover:shadow-[#C6922B]/10">
              <div className="relative overflow-hidden rounded-[1.6rem]">
                ...
                <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-white/0 via-white/0 to-[#0B2341]/20 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
          ...
          <div className="space-y-5">
            ...
            {showroomBenefits.map((benefit, index) => {
              ...
              return (
                <div
                  key={benefit.title}
                  className="group relative overflow-hidden rounded-2xl border border-[#D9E3EF] bg-white p-7 shadow-sm transition-all duration-500 ease-in-out hover:-translate-y-1.5 hover:border-[#C6922B]/60 hover:bg-[#0B2341] hover:shadow-xl hover:shadow-[#0B2341]/15"
                >
                  {/* Top Accent Line on Hover */}
                  <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-[#0B2341] via-[#C6922B] to-[#E2B354] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />

                  <div className="flex gap-6">
                    {/* Icon */}
                    <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-[#0B2341]/5 text-[#0B2341] transition-all duration-500 group-hover:bg-[#C6922B] group-hover:text-white group-hover:shadow-lg group-hover:shadow-[#C6922B]/30">
                      <Icon size={24} />
                    </div>
                    ...
                    <div>
                      <div className="flex items-center justify-between">
                        <h3 className="text-xl font-bold text-[#0B2341] transition-colors duration-500 group-hover:text-white">
                          {benefit.title}
                        </h3>
