        ...
        <div className="grid items-center gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          <div>
            ...
            <h1 className="mt-6 max-w-xl text-4xl font-black leading-[1.08] tracking-[-0.04em] sm:text-5xl lg:text-[4rem]">
              ...
              <span className="text-[#f5c54e]">{t('hero.titleHighlight')}</span>
            </h1>
          ...
          <div className="relative">
            <div className="rounded-[28px] border border-white/10 bg-[#07182d]/80 p-6 shadow-[0_30px_80px_rgba(0,0,0,0.26)] backdrop-blur-md">
              <p className="text-[10px] font-extrabold uppercase tracking-[0.2em] text-[#f5c54e]">{t('hero.card.eyebrow')}</p>
              <h2 className="mt-2 text-2xl font-black text-white">{t('hero.card.heading')}</h2>
