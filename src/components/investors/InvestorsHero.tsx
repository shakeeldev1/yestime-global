...
const highlights = [
  { icon: TrendingUp, label: 'Long-term focus', value: 'Sustainable growth' },
  { icon: Handshake, label: 'Strategic fit', value: 'Shared vision' },
  { icon: ShieldCheck, label: 'Trust', value: 'Clear accountability' },
  { icon: Sparkles, label: 'Global reach', value: 'Cross-market value' },
]
  ...
  return (
    <section className="relative overflow-hidden bg-[#020c1c] px-6 py-12 text-white sm:px-10 sm:py-16 lg:px-[7%] lg:py-20">
      <div className="absolute inset-0">
        <img src="/hero-yes.png" alt="Investors and strategic partners" className="h-full w-full object-cover object-center opacity-80" />
